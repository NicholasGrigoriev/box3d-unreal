	...
	float EnergyJoules, FBox3DDestructionEvent& OutEvent) const
{
	...
	OutEvent.Params.bAnchorAllFragments = bAnchorAllFragments;
	...
	FBox3DDestructionEventResult& OutResult)
{
	...
	Params.Fracture.FlattenAxis = Event.Params.FlattenAxis;
	...
	Params.HullInsetCm = Event.Params.HullInsetCm;
	Params.bStartAsleep = Event.Params.bStartAsleep;
	Params.bStructural = Event.Params.bStructural;
	Params.bAnchorAllFragments = Event.Params.bAnchorAllFragments;
